...
const file_transactions_proto_rawDesc = "" +
	...
	"\rskipped_ticks\x18\x01 \x03(\v2/.qubic.lts.transactions.pb.SkippedTicksIntervalR\fskippedTicks2\xe7\r\n" +
	...
	"/v1/statusB2Z0github.com/qubic/archive-query-service/protobuf/b\x06proto3"
...
var file_transactions_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_transactions_proto_goTypes = []any{
	...
	nil,                                               // 32: qubic.lts.transactions.pb.GetArchiverStatusResponse.LastProcessedTicksPerEpochEntry
	nil,                                               // 33: qubic.lts.transactions.pb.GetArchiverStatusResponse.EmptyTicksPerEpochEntry
...
var file_transactions_proto_depIdxs = []int32{
	...
	32, // 14: qubic.lts.transactions.pb.GetArchiverStatusResponse.last_processed_ticks_per_epoch:type_name -> qubic.lts.transactions.pb.GetArchiverStatusResponse.LastProcessedTicksPerEpochEntry
	...
	33, // 17: qubic.lts.transactions.pb.GetArchiverStatusResponse.empty_ticks_per_epoch:type_name -> qubic.lts.transactions.pb.GetArchiverStatusResponse.EmptyTicksPerEpochEntry
	...
	7,  // 20: qubic.lts.transactions.pb.TransactionsService.GetIdentityTransactions:input_type -> qubic.lts.transactions.pb.GetIdentityTransactionsRequest
	11, // 21: qubic.lts.transactions.pb.TransactionsService.GetIdentityTransfersInTickRangeV2:input_type -> qubic.lts.transactions.pb.GetTransferTransactionsPerTickRequestV2
	2,  // 22: qubic.lts.transactions.pb.TransactionsService.GetTickTransactionsV2:input_type -> qubic.lts.transactions.pb.GetTickTransactionsRequestV2
	4,  // 23: qubic.lts.transactions.pb.TransactionsService.GetTickTransactions:input_type -> qubic.lts.transactions.pb.GetTickTransactionsRequest
	5,  // 24: qubic.lts.transactions.pb.TransactionsService.GetTickApprovedTransactions:input_type -> qubic.lts.transactions.pb.GetTickApprovedTransactionsRequest
	18, // 25: qubic.lts.transactions.pb.TransactionsService.GetTransaction:input_type -> qubic.lts.transactions.pb.GetTransactionRequest
	18, // 26: qubic.lts.transactions.pb.TransactionsService.GetTransactionStatus:input_type -> qubic.lts.transactions.pb.GetTransactionRequest
	18, // 27: qubic.lts.transactions.pb.TransactionsService.GetTransactionV2:input_type -> qubic.lts.transactions.pb.GetTransactionRequest
	24, // 28: qubic.lts.transactions.pb.TransactionsService.GetTickData:input_type -> qubic.lts.transactions.pb.GetTickDataRequest
	34, // 29: qubic.lts.transactions.pb.TransactionsService.GetArchiverStatus:input_type -> google.protobuf.Empty
	8,  // 30: qubic.lts.transactions.pb.TransactionsService.GetIdentityTransactions:output_type -> qubic.lts.transactions.pb.GetIdentityTransactionsResponse
	12, // 31: qubic.lts.transactions.pb.TransactionsService.GetIdentityTransfersInTickRangeV2:output_type -> qubic.lts.transactions.pb.GetIdentityTransfersInTickRangeResponseV2
	3,  // 32: qubic.lts.transactions.pb.TransactionsService.GetTickTransactionsV2:output_type -> qubic.lts.transactions.pb.GetTickTransactionsResponseV2
	16, // 33: qubic.lts.transactions.pb.TransactionsService.GetTickTransactions:output_type -> qubic.lts.transactions.pb.GetTickTransactionsResponse
	17, // 34: qubic.lts.transactions.pb.TransactionsService.GetTickApprovedTransactions:output_type -> qubic.lts.transactions.pb.GetTickApprovedTransactionsResponse
	21, // 35: qubic.lts.transactions.pb.TransactionsService.GetTransaction:output_type -> qubic.lts.transactions.pb.GetTransactionResponse
	20, // 36: qubic.lts.transactions.pb.TransactionsService.GetTransactionStatus:output_type -> qubic.lts.transactions.pb.GetTransactionStatusResponse
	22, // 37: qubic.lts.transactions.pb.TransactionsService.GetTransactionV2:output_type -> qubic.lts.transactions.pb.GetTransactionResponseV2
	25, // 38: qubic.lts.transactions.pb.TransactionsService.GetTickData:output_type -> qubic.lts.transactions.pb.GetTickDataResponse
	26, // 39: qubic.lts.transactions.pb.TransactionsService.GetArchiverStatus:output_type -> qubic.lts.transactions.pb.GetArchiverStatusResponse
