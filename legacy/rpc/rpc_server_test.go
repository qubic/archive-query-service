...
func TestRpcServer_GetEpochTickListV2_GivenAscendingTrue_ReturnInAscendingOrder(t *testing.T) {
	...
	server := Server{
		qb:               qs,
		statusService:    nil,
		paginationLimits: NewPaginationLimits(true, []int{10, 25, 50, 100}, 10, 10000),
	}
...
func TestRpcServer_GetEpochTickListV2_GivenMultipleIntervals_ReturnPageOverIntervalBorders(t *testing.T) {
	...
	server := Server{
		qb:               qs,
		statusService:    nil,
		paginationLimits: NewPaginationLimits(true, []int{10, 25, 50, 100, 1000}, 10, 10000),
	}
...
func TestRpcServer_GetEpochTickListV2_GivenMultipleIntervals_ReturnCorrectPages(t *testing.T) {
	...
	server := Server{
		qb:               qs,
		statusService:    nil,
		paginationLimits: NewPaginationLimits(true, []int{10, 25, 50, 60, 100}, 10, 10000),
	}
...
func TestRpcServer_GetEpochTickListV2_GivenValidEpochValues_ThenNoError(t *testing.T) {
	...
	server := Server{qb: qs, statusService: nil, paginationLimits: NewPaginationLimits(true, []int{10, 25, 50, 100}, 10, 10000)}
