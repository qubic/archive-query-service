...
func TestClient_QueryEmptyTicks(t *testing.T) {
	tests := []struct {
		...
		{
			name:           "No ticks are empty, 1 tick",
			startTick:      100,
			endTick:        100,
			epoch:          1,
			mockResponses:  []*TickListSearchResponse{{Hits: createHits(1, []string{"100"})}},
			expectedResult: []uint32{},
			expectedErr:    "",
		},
		{
			name:           "No ticks are empty, 2 ticks",
			startTick:      100,
			endTick:        101,
			epoch:          1,
			mockResponses:  []*TickListSearchResponse{{Hits: createHits(2, []string{"100", "101"})}},
			expectedResult: []uint32{},
			expectedErr:    "",
		},
		{
			name:           "One tick is empty",
			startTick:      100,
			endTick:        100,
			epoch:          1,
			mockResponses:  []*TickListSearchResponse{{Hits: createHits(0, []string{})}},
			expectedResult: []uint32{100},
			expectedErr:    "",
		},
		{
			name:           "Two ticks are empty",
			startTick:      100,
			endTick:        101,
			epoch:          1,
			mockResponses:  []*TickListSearchResponse{{Hits: createHits(0, []string{})}},
			expectedResult: []uint32{100, 101},
			expectedErr:    "",
		},
		{
			name:           "First of two ticks is empty",
			startTick:      100,
			endTick:        101,
			epoch:          1,
			mockResponses:  []*TickListSearchResponse{{Hits: createHits(1, []string{"100"})}},
			expectedResult: []uint32{101},
			expectedErr:    "",
		},
		{
			name:           "Second of two ticks is empty",
			startTick:      100,
			endTick:        101,
			epoch:          1,
			mockResponses:  []*TickListSearchResponse{{Hits: createHits(1, []string{"101"})}},
			expectedResult: []uint32{100},
			expectedErr:    "",
		},
		{
			name:           "Middle of three ticks is empty",
			startTick:      100,
			endTick:        102,
			epoch:          1,
			mockResponses:  []*TickListSearchResponse{{Hits: createHits(1, []string{"100", "102"})}},
			expectedResult: []uint32{101},
			expectedErr:    "",
		},
		{
