...
func (m *MockTransactionRepository) GetTransactionsForTickNumber(ctx context.Context, tickNumber uint32, filters entities.Filters, from, size uint32) ([]*api.Transaction, *entities.Hits, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransactionsForTickNumber", ctx, tickNumber, filters, from, size)
	ret0, _ := ret[0].([]*api.Transaction)
	ret1, _ := ret[1].(*entities.Hits)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockTransactionRepositoryMockRecorder) GetTransactionsForTickNumber(ctx, tickNumber, filters, from, size any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransactionsForTickNumber", reflect.TypeOf((*MockTransactionRepository)(nil).GetTransactionsForTickNumber), ctx, tickNumber, filters, from, size)
}
