...
type GetLastProcessedTickResponse struct {
	...
	LastProcessedLogTick uint32 `protobuf:"varint,4,opt,name=last_processed_log_tick,json=lastProcessedLogTick,proto3" json:"last_processed_log_tick,omitempty"` // TODO remove
	LogTickNumber        uint32 `protobuf:"varint,5,opt,name=log_tick_number,json=logTickNumber,proto3" json:"log_tick_number,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
const file_messages_proto_rawDesc = "" +
	...
	"\x18processed_tick_intervals\x18\x01 \x03(\v2*.qubic.v2.archive.pb.ProcessedTickIntervalB3\xbaG0\x92\x02-A list of tick intervals that were processed.R\x16processedTickIntervals\"\xef\x03\n" +
	...
	"\x15interval_initial_tick\x18\x03 \x01(\rB4\xbaG1\x92\x02.The initial tick of the current tick interval.R\x13intervalInitialTick\x12f\n" +
	"\x17last_processed_log_tick\x18\x04 \x01(\rB/\xbaG*\x92\x02'The last processed tick for event logs.\x18\x01R\x14lastProcessedLogTick\x12U\n" +
	"\x0flog_tick_number\x18\x05 \x01(\rB-\xbaG*\x92\x02'The last processed tick for event logs.R\rlogTickNumber\"n\n" +
