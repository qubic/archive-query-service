...
type GetLastProcessedTickResponse struct {
	...
	LogTickNumber       uint32                 `protobuf:"varint,4,opt,name=log_tick_number,json=logTickNumber,proto3" json:"log_tick_number,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *GetLastProcessedTickResponse) GetLogTickNumber() uint32 {
	if x != nil {
		return x.LogTickNumber
	}
	return 0
}
...
// CustomMessageData contains fields specific to custom message events (type 255).
//
// Custom messages arrive in one of two shapes, never both. A message of 8 bytes or fewer is
// packed little-endian into a uint64 and returned in `value`. A longer message is returned in
// the top level `raw_payload` field instead, and `value` is then 0 and carries no meaning.
// Clients should read `raw_payload` when it is present and fall back to `value` otherwise.
...
type OracleQueryStatusChangeData struct {
	...
	InterfaceIndex uint64                 `protobuf:"varint,3,opt,name=interface_index,json=interfaceIndex,proto3" json:"interface_index,omitempty"`
	QueryType      uint64                 `protobuf:"varint,4,opt,name=query_type,json=queryType,proto3" json:"query_type,omitempty"`
	QueryStatus    uint64                 `protobuf:"varint,5,opt,name=query_status,json=queryStatus,proto3" json:"query_status,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *OracleQueryStatusChangeData) Reset() {
	*x = OracleQueryStatusChangeData{}
	mi := &file_messages_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OracleQueryStatusChangeData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OracleQueryStatusChangeData) ProtoMessage() {}

func (x *OracleQueryStatusChangeData) ProtoReflect() protoreflect.Message {
	mi := &file_messages_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OracleQueryStatusChangeData.ProtoReflect.Descriptor instead.
func (*OracleQueryStatusChangeData) Descriptor() ([]byte, []int) {
	return file_messages_proto_rawDescGZIP(), []int{33}
}

func (x *OracleQueryStatusChangeData) GetQueryingEntity() string {
	if x != nil {
		return x.QueryingEntity
	}
	return ""
}

func (x *OracleQueryStatusChangeData) GetQueryId() uint64 {
	if x != nil {
		return x.QueryId
	}
	return 0
...
func (x *OracleQueryStatusChangeData) GetInterfaceIndex() uint64 {
	if x != nil {
...
func (x *OracleQueryStatusChangeData) GetQueryType() uint64 {
	if x != nil {
		return x.QueryType
	}
	return 0
...
func (x *OracleQueryStatusChangeData) GetQueryStatus() uint64 {
	if x != nil {
...
type OracleSubscriberLogMessageData struct {
	...
	InterfaceIndex      uint64                 `protobuf:"varint,2,opt,name=interface_index,json=interfaceIndex,proto3" json:"interface_index,omitempty"`
	ContractIndex       uint64                 `protobuf:"varint,3,opt,name=contract_index,json=contractIndex,proto3" json:"contract_index,omitempty"`
	PeriodMillis        uint64                 `protobuf:"varint,4,opt,name=period_millis,json=periodMillis,proto3" json:"period_millis,omitempty"`
	FirstQueryTimestamp uint64                 `protobuf:"varint,5,opt,name=first_query_timestamp,json=firstQueryTimestamp,proto3" json:"first_query_timestamp,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}

func (x *OracleSubscriberLogMessageData) Reset() {
	*x = OracleSubscriberLogMessageData{}
	mi := &file_messages_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OracleSubscriberLogMessageData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OracleSubscriberLogMessageData) ProtoMessage() {}

func (x *OracleSubscriberLogMessageData) ProtoReflect() protoreflect.Message {
	mi := &file_messages_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OracleSubscriberLogMessageData.ProtoReflect.Descriptor instead.
func (*OracleSubscriberLogMessageData) Descriptor() ([]byte, []int) {
	return file_messages_proto_rawDescGZIP(), []int{34}
}

func (x *OracleSubscriberLogMessageData) GetSubscriptionId() uint64 {
	if x != nil {
...
func (x *OracleSubscriberLogMessageData) GetInterfaceIndex() uint64 {
	if x != nil {
		return x.InterfaceIndex
	}
	return 0
...
func (x *OracleSubscriberLogMessageData) GetContractIndex() uint64 {
	if x != nil {
		return x.ContractIndex
	}
	return 0
...
func (x *OracleSubscriberLogMessageData) GetPeriodMillis() uint64 {
	if x != nil {
...
func (x *OracleSubscriberLogMessageData) GetFirstQueryTimestamp() uint64 {
	if x != nil {
		return x.FirstQueryTimestamp
	}
	return 0
}
...
type Event struct {
	...
	// Undecoded event payload. Present for event types 4-7, 9, 10 and for type 255 custom
	// messages longer than 8 bytes. Omitted entirely when the event carries no raw payload.
	...
	//	*Event_OracleQueryStatusChange
	//	*Event_OracleSubscriberLogMessage
...
func (x *Event) GetOracleQueryStatusChange() *OracleQueryStatusChangeData {
	if x != nil {
		if x, ok := x.EventData.(*Event_OracleQueryStatusChange); ok {
			return x.OracleQueryStatusChange
		}
	}
	return nil
}

func (x *Event) GetOracleSubscriberLogMessage() *OracleSubscriberLogMessageData {
	if x != nil {
		if x, ok := x.EventData.(*Event_OracleSubscriberLogMessage); ok {
			return x.OracleSubscriberLogMessage
		}
	}
	return nil
}
...
type Event_OracleQueryStatusChange struct {
	OracleQueryStatusChange *OracleQueryStatusChangeData `protobuf:"bytes,20,opt,name=oracle_query_status_change,json=oracleQueryStatusChange,proto3,oneof"`
}

type Event_OracleSubscriberLogMessage struct {
	OracleSubscriberLogMessage *OracleSubscriberLogMessageData `protobuf:"bytes,21,opt,name=oracle_subscriber_log_message,json=oracleSubscriberLogMessage,proto3,oneof"`
}
...
func (*Event_OracleQueryStatusChange) isEvent_EventData() {}

func (*Event_OracleSubscriberLogMessage) isEvent_EventData() {}
...
const file_messages_proto_rawDesc = "" +
	...
	"\x18processed_tick_intervals\x18\x01 \x03(\v2*.qubic.v2.archive.pb.ProcessedTickIntervalB3\xbaG0\x92\x02-A list of tick intervals that were processed.R\x16processedTickIntervals\"\x87\x03\n" +
	...
	"\x0finterface_index\x18\x03 \x01(\x04R\x0einterfaceIndex\x12\x1d\n" +
	"\n" +
	"query_type\x18\x04 \x01(\x04R\tqueryType\x12!\n" +
	"\fquery_status\x18\x05 \x01(\x04R\vqueryStatus\"\xf2\x01\n" +
	"\x1eOracleSubscriberLogMessageData\x12'\n" +
	"\x0fsubscription_id\x18\x01 \x01(\x04R\x0esubscriptionId\x12'\n" +
	"\x0finterface_index\x18\x02 \x01(\x04R\x0einterfaceIndex\x12%\n" +
	"\x0econtract_index\x18\x03 \x01(\x04R\rcontractIndex\x12#\n" +
	"\rperiod_millis\x18\x04 \x01(\x04R\fperiodMillis\x122\n" +
	"\x15first_query_timestamp\x18\x05 \x01(\x04R\x13firstQueryTimestamp\"\xcb\f\n" +
	"\x05Event\x12\x14\n" +
	...
	")asset_possession_managing_contract_change\x18\x13 \x01(\v2>.qubic.v2.archive.pb.AssetPossessionManagingContractChangeDataH\x00R%assetPossessionManagingContractChange\x12o\n" +
	"\x1aoracle_query_status_change\x18\x14 \x01(\v20.qubic.v2.archive.pb.OracleQueryStatusChangeDataH\x00R\x17oracleQueryStatusChange\x12x\n" +
	"\x1doracle_subscriber_log_message\x18\x15 \x01(\v23.qubic.v2.archive.pb.OracleSubscriberLogMessageDataH\x00R\x1aoracleSubscriberLogMessageB\f\n" +
	"\n" +
	"event_dataB\x13\n" +
...
var file_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_messages_proto_goTypes = []any{
	...
	(*GetEventLogsRequest)(nil),                       // 36: qubic.v2.archive.pb.GetEventLogsRequest
	(*GetEventLogsResponse)(nil),                      // 37: qubic.v2.archive.pb.GetEventLogsResponse
	nil,                                               // 38: qubic.v2.archive.pb.GetTransactionsForTickRequest.FiltersEntry
	nil,                                               // 39: qubic.v2.archive.pb.GetTransactionsForTickRequest.RangesEntry
	nil,                                               // 40: qubic.v2.archive.pb.ShouldFilter.TermsEntry
	nil,                                               // 41: qubic.v2.archive.pb.ShouldFilter.RangesEntry
	nil,                                               // 42: qubic.v2.archive.pb.GetTransactionsForIdentityRequest.FiltersEntry
	nil,                                               // 43: qubic.v2.archive.pb.GetTransactionsForIdentityRequest.ExcludeEntry
	nil,                                               // 44: qubic.v2.archive.pb.GetTransactionsForIdentityRequest.RangesEntry
	nil,                                               // 45: qubic.v2.archive.pb.GetEventLogsRequest.FiltersEntry
	nil,                                               // 46: qubic.v2.archive.pb.GetEventLogsRequest.ExcludeEntry
	nil,                                               // 47: qubic.v2.archive.pb.GetEventLogsRequest.RangesEntry
}
...
func file_messages_proto_init() {
	...
	file_messages_proto_msgTypes[35].OneofWrappers = []any{
		...
		(*Event_OracleQueryStatusChange)(nil),
		(*Event_OracleSubscriberLogMessage)(nil),
	}
	type x struct{}
