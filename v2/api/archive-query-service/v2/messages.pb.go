...
func (x *Event) GetEmittingContractIndex() uint64 {
	if x != nil {
...
func (x *Event) GetCategory() uint32 {
	if x != nil {
		return x.Category
	}
	return 0
...
const file_messages_proto_rawDesc = "" +
	...
	"tickNumber\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\x04R\ttimestamp\x126\n" +
	"\x17emitting_contract_index\x18\x04 \x01(\x04R\x15emittingContractIndex\x12)\n" +
	"\x10transaction_hash\x18\x05 \x01(\tR\x0ftransactionHash\x12\x15\n" +
