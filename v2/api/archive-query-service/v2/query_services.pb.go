...
var file_query_services_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x8e, 0x09, 0x0a, 0x13, 0x41, 0x72, 0x63, 0x68, 0x69,
	...
	0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x73, 0x42, 0x2c, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_query_services_proto_depIdxs = []int32{
	...
	10, // 11: qubic.v2.archive.pb.ArchiveQueryService.GetComputorsListsForEpoch:output_type -> qubic.v2.archive.pb.GetComputorsListForEpochResponse
	11, // 12: qubic.v2.archive.pb.ArchiveQueryService.GetLastProcessedTick:output_type -> qubic.v2.archive.pb.GetLastProcessedTickResponse
	12, // 13: qubic.v2.archive.pb.ArchiveQueryService.GetProcessedTickIntervals:output_type -> qubic.v2.archive.pb.GetProcessedTicksIntervalsResponse
