...
const file_query_services_proto_rawDesc = "" +
	"\n" +
	"\x14query_services.proto\x12\x13qubic.v2.archive.pb\x1a\x0emessages.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1bopenapiv3/annotations.proto2\xae\x0e\n" +
	"\x13ArchiveQueryService\x12\xd4\x01\n" +
	"\x14GetTransactionByHash\x120.qubic.v2.archive.pb.GetTransactionByHashRequest\x1a1.qubic.v2.archive.pb.GetTransactionByHashResponse\"W\xbaG'\n" +
	"\fTransactions\x12\x17Get Transaction By Hash\x82\xd3\xe4\x93\x02':\x01*b\vtransaction\"\x15/getTransactionByHash\x12\xdf\x01\n" +
	...
	"\aArchive\x12\x1cGet Processed Tick Intervals\x82\xd3\xe4\x93\x026b\x18processed_tick_intervals\x12\x1a/getProcessedTickIntervals\x12\x9f\x01\n" +
	...
	"Get Health\x1abHealth check. This is for internal use only and can change any time. Do not rely on this endpoint.\x82\xd3\xe4\x93\x02\t\x12\a/healthB\xfb\a\xbaG\xcb\a\x12\xc4\x04\n" +
	"\x0fQubic Query API\x12\xa9\x04API for querying historical Qubic ledger data.\n" +
	"\n" +
	...
	"- Amount = 0\n" +
	"\n" +
	"Affects: *Get Transaction By Hash*, *Get Transactions For Tick*, *Get Transactions For Identity*.2\x051.0.0\x1a \n" +
