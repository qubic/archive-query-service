...
func (m *MockTransactionsService) GetTransactionsForIdentity(ctx context.Context, identity string, filters2 entities.Filters, ranges map[string][]*entities.Range, from, size uint32) (*entities.TransactionsResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransactionsForIdentity", ctx, identity, filters2, ranges, from, size)
...
func (mr *MockTransactionsServiceMockRecorder) GetTransactionsForIdentity(ctx, identity, filters2, ranges, from, size any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransactionsForIdentity", reflect.TypeOf((*MockTransactionsService)(nil).GetTransactionsForIdentity), ctx, identity, filters2, ranges, from, size)
}
...
func (m *MockEventsService) GetEvents(ctx context.Context, queryFilters entities.Filters, ranges map[string][]*entities.Range, from, size uint32) (*entities.EventsResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEvents", ctx, queryFilters, ranges, from, size)
...
func (mr *MockEventsServiceMockRecorder) GetEvents(ctx, queryFilters, ranges, from, size any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEvents", reflect.TypeOf((*MockEventsService)(nil).GetEvents), ctx, queryFilters, ranges, from, size)
}
